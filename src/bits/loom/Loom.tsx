        ...
        const animate = () => {
            timeoutId = setTimeout(function () {
                ...
                let weave = treadling
                    ...
                    .multiply(threading)
                let threadingColor = colorMatrix(
                    threadingColorBase,
                    theme.theme.colorMatrix
                )
                threading.printContext(
                    context,
                    squareSize,
                    `rgba(${threadingColor[0]}, ${threadingColor[1]}, ${threadingColor[2]}, ${threadingColor[3]})`
                )
                let treadlingColor = colorMatrix(
                    treadlingColorBase,
                    theme.theme.colorMatrix
                )
