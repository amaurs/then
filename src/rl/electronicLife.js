...
const ACTIONS = [
    ...
    { key: 'Plant', value: 0 },
    { key: 'Plant', value: -1 },
    { key: 'PlantEater', value: 1 },
    { key: 'PlantEater', value: 0 },
    { key: 'PlantEater', value: -1 },
    { key: 'PlantEaterEater', value: 1 },
    { key: 'PlantEaterEater', value: 0 },
    { key: 'PlantEaterEater', value: -1 },
]
...
class World {
    ...
    toString() {
        ...
        return stringMap.map(function (row) {
            return row.split('')
        })
    }
}
...
class ElectronicLife extends Environment {
    ...
    tick(actionIndex) {
        ...
        return { isDone: done, reward: done ? -10 : 0.1 }
    }
