...
import { Agent } from './qLearningAgent'
    ...
    tick() {
        ...
        if (stepRes.isDone) {
            ...
            newData.push({
                ...
                duration: this.state.episodeDuration,
            })
                    ...
                    <div className="col-third">
                        ...
                        >
                            <VictoryLabel
                                ...
                                style={{ fill: '#0C090D', fontStyle: 'bold' }}
                            />
                            <VictoryLabel
                                x={220}
                                y={285}
                            ...
                            <VictoryLine
                                ...
                                y="duration"
                                style={{
                                    data: { stroke: '#53B3CB', strokeWidth: 3 },
                                }}
                            />
                        </VictoryChart>
                    </div>
